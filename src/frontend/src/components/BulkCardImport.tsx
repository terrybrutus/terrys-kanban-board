      ...
      <DialogContent className="max-w-lg w-full max-h-[90vh] flex flex-col overflow-hidden">
                ...
                >
                  ...
                  <TabsContent value="plaintext" className="mt-3">
                    <Textarea
                      ...
                      rows={6}
                      className="text-sm font-mono resize-none max-h-48 overflow-y-auto"
                    />
        ...
        {step === "preview" && (
          <div className="flex flex-col min-h-0 flex-1 overflow-hidden">
              ...
              <div className="space-y-3 pt-1">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-semibold text-foreground">
                    Preview —{" "}
                    <span className="text-primary">{parsedCards.length}</span>{" "}
                    card
            ...
            {/* Fixed footer buttons — always visible */}
            <div className="shrink-0 flex justify-between gap-2 pt-3 border-t border-border mt-3">
              <Button
                variant="ghost"
                size="sm"
        ...
        {step === "done" && (
          <div className="flex flex-col min-h-0 flex-1 overflow-hidden">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-foreground">
                      Done! <span className="text-primary">{doneCount}</span>{" "}
                      card
            ...
            <div className="shrink-0 flex justify-end pt-3 border-t border-border mt-3">
