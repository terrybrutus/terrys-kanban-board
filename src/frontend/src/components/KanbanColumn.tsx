...
export default function KanbanColumn({
  ...
  const { setNodeRef: setDropRef, isOver } = useDroppable({
    ...
    // Disable card drop target when dragging a column
  ...
  return (
    ...
    >
      ...
      <SortableContext items={cardIds} strategy={verticalListSortingStrategy}>
        <div
          ref={setDropRef}
          className={`flex-1 overflow-y-auto px-3 pb-2 space-y-2 min-h-[80px] max-h-[calc(100vh-260px)] transition-colors rounded-b-md ${
